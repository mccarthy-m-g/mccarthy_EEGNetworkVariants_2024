...
Additional supplementary results can be found in the online supplement (). These include: (1) phase, amplitude, and phase (Hilbert transform) coupling functional connectomes with independent fill scales for all recordings, presented as adjacency matrices rather than connectivity profiles; and (2) larger versions of all the similarity matrices presented in this manuscript. <!--; (3) model fits and diagnostics for all group-level mixed beta regression models of functional connectome similarity, and standardized mean differences for all group-level functional connectome similarity contrasts; ... -->
