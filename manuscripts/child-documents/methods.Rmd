...
The fit of the model was assessed using posterior predictive checks [@gelmanetal_BayesianDataAnalysis_2013; @gelmanetal_RegressionOtherStories_2020; @gelmanhill_DataAnalysisUsing_2006], and inspection of (standardized or simulated residuals)



After fitting the model we constructed a reference grid using estimated marginal means [], then used this to estimate the difference in functional connectome similarity within and between participants using pairwise contrasts.

The estimated marginal means and pairwise contrasts were back-transformed to the response scale (0-1) for interpretability.

These contrasts were the estimands of our model and will be the focus of discussion.
